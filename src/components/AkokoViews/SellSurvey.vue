      ...
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn
                  ...
                  :loading="btn_loader"
                  :disabled="btn_loader"
          ><v-icon left>mdi-library-plus</v-icon>Add Sell Survey</v-btn>
          ...
          >
            ...
            >
              ...
              <td class="align-center">
                <v-btn small color="grey darken-1" @click="editSurvey"><v-icon>mdi-pencil</v-icon>Edit</v-btn>
                <v-btn small color="red darken-1" @click="deleteSurvey"><v-icon>mdi-delete</v-icon>Delete</v-btn>
              </td>
            </template>
          </v-data-table>
        </material-card>
